...
try {
  const compile = spawnSync(
    ...
    [
      ...
      "tests/pressure-prediction-v4.test.ts",
      "tests/pressure-prediction-v4-estimator.test.ts",
      "tests/pressure-equilibrium-v4.test.ts",
  ...
  if (compile.status !== 0) {
    ...
    const run = spawnSync(
      ...
      [
        ...
        join(output, "tests/pressure-prediction-v4.test.js"),
        join(output, "tests/pressure-prediction-v4-estimator.test.js"),
        join(output, "tests/pressure-equilibrium-v4.test.js"),
