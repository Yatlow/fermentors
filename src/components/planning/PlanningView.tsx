  ...
  return (
    <section className="brew-planning" dir="rtl">
      ...
      {!data.loading && !data.error && <>
        ...
        {tab === "calendar" && <>{holidayError && <details><summary>לוח החגים לא נטען</summary>{holidayError}</details>}<PlanningWeeklyRecommendations settings={settings} plans={plans} tanks={tanks} sources={productionTanks} pallets={pallets} actuals={actuals} holidays={holidays} today={today} workspace={workspace} disabled={disabled} saveWeek={data.saveWeek}/></>}
