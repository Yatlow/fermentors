...
import {
    getStyleAverages,
    type StyleAverages,
} from "../../SERVICES/getAndPost/getStyleAverages";
...
function makeTooltipRenderer(
    ...
    return function TooltipRenderer({ active, label, payload }: TooltipContentProps) {
        ...
        const DHLine = makeDHNoteLine(dayNumber, chartData);
                                    ...
                                    <div className="batch-chart-graph" dir="ltr">
                                        <ResponsiveContainer width="100%" height={260}>
                                            ...
                                            >
                                                ...
                                                {chartData
                                                    .filter((p) => p.TankCloseNote && p[metric.key] !== null)
                                                    .map((p) => {
