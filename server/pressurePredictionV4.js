// ================================================================
// PRESSURE PREDICTION MODEL V4 — SHARED MODEL BUILDERS
// ================================================================
// Historical backfill is complete. These helpers are reused by the normal
// weekly history scan so fresh brewery data is merged into V4 without a
// separate backfill job or a second measurement scan.
// ================================================================
